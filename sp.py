...
def measurements_of_signal(signal1mean, signal2mean, std, size):    #std: standard devation
    ...
    for i in range(len(std)):
        s1, s2, p1, p2 = 0, 0, 0, 0
        signal1 = np.random.normal(loc=signal1mean, scale= std[i], size=size)
        signal2 = np.random.normal(loc=signal2mean, scale = std[i], size=size)
...
probability1_measurment_signal_1, probability1_measurment_signal_2, probability2_measurment_signal_1, probability2_measurment_signal_2 = measurements_of_signal(signal1mean, signal2mean, std, size)
...
num_of_iterations_with_prob1_signal1, num_of_iterations_with_prob2_signal2, measurments_probability1_signal_1, measurments_probability2_signal_2 = iterations_required(iterations, std, signal1mean, signal2mean)
...
plotting_iterations_results(std, num_of_iterations_with_prob1_signal1, num_of_iterations_with_prob2_signal2)
