...
def calculation(input_signal, output_signals, frequency, bandwidth, IMPEDANCE):  #Shape of the inputs: input_signal = [], output_signals = [[Output from amp0], [[Output from amp1], [Output from amp2],....,[Output from amp'n'], frequency = (), bandwidth = (), Impedence = ()] 
    fourier = []
    fourier_magnitude = []
    ...
    retrived_noise_amplifiers[0] = corrected_noise_0
